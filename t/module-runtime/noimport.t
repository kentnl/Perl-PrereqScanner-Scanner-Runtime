...
require_module("BadExample1");
use_module("BadExample2");
use_module("BadExample3",5.6);
use_package_optimistically("BadExample4");
use_package_optimistically("BadExample5", 5.6);
...
for my $key ( 1 .. 5 ) {
  ...
  ok( !exists $prereqs->{"BadExample$key"}, "Function without import $key is ignored" ) or $hash_bad = 1;
}
for my $key ( 3, 5 ) {
